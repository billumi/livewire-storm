...
package chenxi.livewire.yahoo;

import chenxi.livewire.yahoo.histquotes.HistQuotesRequest;
import chenxi.livewire.yahoo.histquotes.Interval;
import chenxi.livewire.yahoo.quotes.fx.FxQuote;
import chenxi.livewire.yahoo.quotes.fx.FxQuotesRequest;
import chenxi.livewire.yahoo.quotes.stock.StockQuotesData;
import chenxi.livewire.yahoo.quotes.stock.StockQuotesRequest;
...
public class YahooFinance {
    ...
    /**
    * Sends a basic quotes request to Yahoo Finance. This will return a {@link chenxi.livewire.yahoo.Stock} object
    * with its {@link chenxi.livewire.yahoo.quotes.stock.StockQuote}, {@link chenxi.livewire.yahoo.quotes.stock.StockStats}
    * and {@link chenxi.livewire.yahoo.quotes.stock.StockDividend} member fields
    ...
    * @return           a {@link chenxi.livewire.yahoo.Stock} object containing the requested information
    ...
    */
     ...
     * historical stock quote data. Including historical data will cause the {@link chenxi.livewire.yahoo.Stock}
     * object's member field {@link chenxi.livewire.yahoo.histquotes.HistoricalQuote} to be filled in
    ...
    * The Stock objects have their {@link chenxi.livewire.yahoo.quotes.stock.StockQuote}, {@link chenxi.livewire.yahoo.quotes.stock.StockStats}
    * and {@link chenxi.livewire.yahoo.quotes.stock.StockDividend} member fields
    * filled in with the available data.
    * <p>
    ...
    */
     ...
     * objects their member field {@link chenxi.livewire.yahoo.histquotes.HistoricalQuote} to be filled in
     * with the default past year term at monthly intervals.
     * <p>
     ...
     * Some common symbols can easily be found in the ENUM {@link chenxi.livewire.yahoo.quotes.fx.FxSymbols}
